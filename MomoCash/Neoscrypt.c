...
//  MomoCash
//
//  Created by weipeng.mao on 2018/6/26.
...
t = a + d; t = ROTL32b(t,  7); b ^= t; \
t = b + a; t = ROTL32b(t,  9); c ^= t; \
t = c + b; t = ROTL32b(t, 13); d ^= t; \
t = d + c; t = ROTL32b(t, 18); a ^= t;
...
#define quarter(a,b,c,d) \
a += b; t = d ^ a; d = ROTL32b(t, 16); \
c += d; t = b ^ c; b = ROTL32b(t, 12); \
a += b; t = d ^ a; d = ROTL32b(t,  8); \
c += d; t = b ^ c; b = ROTL32b(t,  7);
